...
for (var i = 1; i <= numOfImages; i++) {
  var _image = new Image("./images/image-".concat(i, ".jpg"), "image-".concat(i));
...
for (var _i = 0; _i < Object.keys(_.default).length; _i++) {
  var dot = document.createElement("i");
  dot.className = "fas fa-dot-circle";
  dots.appendChild(dot);
}

var dotsAll = dots.querySelectorAll("i");
  ...
  if (centerImg.src.includes("image-1") && !centerImg.src.includes("image-10")) {
    ...
    (0, _animeEs.default)({
      ...
      complete: function complete(anim) {
        leftImg.src = _.default["image-".concat(image - 2)];
        leftImg.className = "leftImg img";
        centerImg.src = _.default["image-".concat(image - 1)];
        centerImg.className = "centerImg img";
        rightImg.src = _.default["image-".concat(image)];
...
right.onclick = function () {
  ...
  if (centerImg.src.includes("image-10")) {
    ...
    (0, _animeEs.default)({
      ...
      easing: 'easeInOutSine',
      complete: function complete(anim) {
        leftImg.src = _.default["image-".concat(image)];
        leftImg.className = "leftImg img";
        centerImg.src = _.default["image-".concat(image + 1)];
        centerImg.className = "centerImg img";
        rightImg.src = _.default["image-".concat(image + 2)];
        rightImg.className = "rightImg img";
...
},{"@fortawesome/fontawesome-free/css/all.css":"node_modules/@fortawesome/fontawesome-free/css/all.css","./style.scss":"style.scss","./images/*.jpg":"images/*.jpg","animejs/lib/anime.es.js":"node_modules/animejs/lib/anime.es.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
